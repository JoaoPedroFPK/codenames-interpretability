...
def preflight_random_init(
    *,
    ...
    return {
        ...
        # Only Check 1 (NaN/Inf) is a hard stop. Check 2 (norm growth > 100) is
        # a soft warning: random-init transformers exhibit large residual-stream
        # norms by design, so it prints WARN and proceeds.
