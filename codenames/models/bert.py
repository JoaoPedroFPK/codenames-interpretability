...
Loaded in fp32 (BERT's native precision). ``output_hidden_states=True`` is set
at load time, following the BertModel/BertConfig convention rather than the
AutoModel convention used by the causal models and ModernBERT.
"""
