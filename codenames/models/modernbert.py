...
- fp16 (large enough that fp32 is wasteful)
- ``output_hidden_states`` is passed at inference time, not on the config,
  following the AutoModel convention rather than BertModel/T5
...
- Flash Attention 2 used when importable; falls back to ``"eager"`` otherwise
"""
