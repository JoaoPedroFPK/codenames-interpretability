...
Greedy free-form continuation followed by parsing of the first in-candidate
word. The parsing logic (whole-word matching, hint exclusion,
first-by-character-position) implements the generation-geometry concordance
procedure defined in the thesis.
"""
