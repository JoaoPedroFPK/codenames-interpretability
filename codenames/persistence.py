...
Each helper writes one output stream under a fixed filename format:
...
def save_vector_subsample(
    ...
    Records with invalid vectors (None / wrong shape) appear in the index with
    ``vector_valid=False`` and a zero row in the matrix.
    """
